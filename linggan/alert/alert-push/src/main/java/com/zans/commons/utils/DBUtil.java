...
public class DBUtil {
	...
	private  Connection getConnection() throws SQLException {
		return AlertConstants.dataSourceConcurrentMap.get(name).getConnection();
	}
	 ...
	 * @throws Exception SQL异常
	 */
	public  int replaceAll(String tableName, List<Map<String, Object>> datas) throws Exception {
		/** 影响的行数 **/
		int affectRowCount = -1;
		Connection connection = null;
		PreparedStatement preparedStatement = null;
