...
import com.zans.task.AlertLoopTask;
...
import static com.zans.contants.AlertConstants.alTpx;
        ...
        if (bean.getRule_type() == 0) {
                    ...
                    if(alertAction!=null && alertAction == 3){
                        ...
                        if(MyTools.isNotEmpty(mapList1)){
                            ...
                            if(MyTools.isNotEmpty(mapList1)){
                                ...
                                Integer policy = 1;
                                for (Map<String, Object> objectMap : mapList) {
                                    String mac = (String) objectMap.get("pass");
            ...
            try {
                ...
                for (int i = 0; i < mapList.size(); i++) {
                    ...
                    alTpx.execute(new AlertLoopTask(map,bean.getId()));
                }

            } catch (Exception e) {
                log.error("策略ID:{} 执行任务失败!原因是:",e);
            }
        } else {
