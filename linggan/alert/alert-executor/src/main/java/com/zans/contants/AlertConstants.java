...
//    public static  String ES_INDEX = "t_ip";
    ...
    public static final String SELECT_SQL_AGG = "SELECT a.business_id,a.rule_id,a.keyword_value,a.`notice_info`,a.`record_source`,a.`update_time`,t.alert_level FROM alert_rule_original a " +
    ...
    public static final String UPDATE_SQL_RULE_ORIGINAL = " UPDATE alert_rule_original SET deal_status = 2, dispose_status = 2 WHERE  rule_id = %d AND keyword_value = '%s' ";
