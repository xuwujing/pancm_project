...
public class AlertDaoImpl implements AlertDao {
    ...
    public List<Map<String, Object>> queryAlertRule(String lastUpdateTime) throws Exception {
        ...
        if (MyTools.isNotEmpty(lastUpdateTime)) {
            where += " and ars.update_time >'" + lastUpdateTime + "'";
        }
    ...
    @Override
    public Map<String, Object> queryOne(String tableName, Map<String, Object> whereMap) throws Exception {
        List<Map<String, Object>> mapList = dbUtil.query(tableName,whereMap);
