...
public class SysSwitcher implements Serializable {
    ...
    /**
     * `topo_type` varchar(64) DEFAULT 'ACCESS' COMMENT 'CORE;DISTRIBUTE;ACCESS;核心，汇聚，接入',
     */
    ...
    /**
     * 获取登录协议，all|ssh|telnet
     *
     * @return protocol - 登录协议，all|ssh|telnet
     */
    ...
    /**
     * 设置登录协议，all|ssh|telnet
     *
     * @param protocol 登录协议，all|ssh|telnet
     */
