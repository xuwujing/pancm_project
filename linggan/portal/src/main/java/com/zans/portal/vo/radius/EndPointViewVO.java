...
//    @JSONField(name = "alive_name")
    ...
    @ApiModelProperty(name = "alive_status", value = "检疫区在线状态")
//    @JSONField(name = "alive_status")
    private Integer aliveStatus;

    @ApiModelProperty(name = "alive_status_name", value = "在线状态名称")
//    @JSONField(name = "alive_status_name")
...
//    @JSONField(name = "device_type_name")
    ...
    @ApiModelProperty(name = "device_sub_type_name", value = "设备子类型")
//    @JSONField(name = "device_type_name")
    private String deviceSubTypeName;

    @ApiModelProperty(name = "deviceTypeNameDetect", value = "识别类型")
...
//    @JSONField(name = "reveal_status")
    ...
    @ApiModelProperty(name = "aliveLastTime", value = "在线时间")
...
//    @JSONField(name = "open_port")
    ...
    private String qzDeviceStatusName;
    ...
    public void setAliveNameByMap(Map<Object, String> map) {
        ...
        if (this.aliveStatus != null) {
            this.setAliveStatusName(map.get(this.aliveStatus));
        }
