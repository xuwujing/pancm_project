...
//    }
//
//    public LogBuilder module(Integer module) {
//        this.module = module;
//        return this;
//    }
//
...
//        return new LogOperation(this.userId, this.fromIp, this.module, this.operation, this.content, this.result, new Date(),this.traceId);
//    }
}
