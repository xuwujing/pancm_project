...
public enum EnumErrorCode {
    ...
    LOGIN_USER_LOGIN_OTHER_PLACE(1005, "其它地点登录，需要下线"),
    LOGIN_PASSWORD_ERROR_MAX(1006, "错误次数超过最大限制，请1小时后再试"),
    LOGIN_USER_DISABLE(1007, "用户账号停用，请联系管理员"),
    LICENSE_ERROR(1008,"授权码错误"),
    LICENSE_LIMIT_DAY_SMALL_NOW(1009,"新授权码使用期限小于当前授权码"),
    PERMISSION_NONE(1100, "没有权限，请联系管理员"),
    NEED_LOGIN_AGAIN(1101, "用户session超时，重新登录"),
