...
public class DateHelper {
    ...
    public static Date plusMonth(Date date,int mon){
        Period period = Period.ofMonths(mon);
        return localDate2DateTime(date2LocalDateTime(date).plus(period));
    }
    ...
    public static Long betweenDays(String dateBefore,String dateAfter){
        LocalDate start = LocalDate.parse(dateBefore);
        LocalDate end = LocalDate.parse(dateAfter);
        return start.until(end,ChronoUnit.DAYS);
    }

    public static void main(String[] args) {
        System.out.println(betweenDays("2021-04-29", "2021-04-29"));
