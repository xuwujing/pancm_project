...
public class GuardConfiguration {
    ...
    static final String CONFIG_LOCATION = "classpath:guard/mybatis-config.xml";

    @Autowired
    private MultipleJdbcProperties multipleJdbcProperties;


    @Value("${spring.datasource.guard.driver-class-name}")
    private String driverClassName;

    @Value("${spring.datasource.guard.url}")
    private String url;

    @Value("${spring.datasource.guard.username}")
    private String username;

    @Value("${spring.datasource.guard.password}")
