...
//        return false;
    ...
    public static void run(String path,String name,String cmd) throws IOException, InterruptedException {
        File dir = new File(path);
        List<String> stringList = new ArrayList<>();
        stringList.add("cmd.exe");
        stringList.add("/c");
        stringList.add("supervisord");
        stringList.add("ctl");
        stringList.add(cmd);
        stringList.add(name);
        ProcessBuilder builder1 = new ProcessBuilder();
        builder1.command(stringList);
        builder1.directory(dir);
        builder1.redirectErrorStream(true);
        Process p1 = builder1.start();
