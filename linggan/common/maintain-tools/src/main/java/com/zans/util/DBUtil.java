...
public class DBUtil {
	...
	private  Connection getConnection() throws SQLException {
		return Constants.dataSourceConcurrentMap.get(i).getConnection();
	}
	 ...
	 */
	public  int insertAll(String tableName, List<Map<String, Object>> datas) throws Exception {
		/** 影响的行数 **/
	...
	public  int update(String tableName, Map<String, Object> valueMap, Map<String, Object> whereMap) throws SQLException {
		...
		while (iterator.hasNext()) {
			String key = iterator.next();
			columnSql.append(i == 0 ? "" : ",");
			if(key.toLowerCase().contains("flag")){
				columnSql.append(key + " = "+key+" | ? ");
			}else{
				columnSql.append(key + " = ? ");
			}
	 ...
	 * @throws SQLException
	 */
	public  List<Map<String, Object>> query(String tableName, String whereClause, String[] whereArgs) throws SQLException {
		return query(tableName, false, null, whereClause, whereArgs, null, null, null, null);
	}
	 ...
	 * @throws SQLException
	 */
	public  List<Map<String, Object>> query(String tableName, boolean distinct, String[] columns, String selection, Object[] selectionArgs, String groupBy, String having, String orderBy, String limit) throws SQLException {
...
//		}
	 ...
	 */
	private  String buildQueryString(boolean distinct, String tables, String[] columns, String where, String groupBy, String having, String orderBy, String limit) {
