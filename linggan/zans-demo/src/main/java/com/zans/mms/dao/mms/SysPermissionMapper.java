...
public interface SysPermissionMapper extends Mapper<SysPermission> {
    ...
    List<PermissionRespVO> findPermissionByRole(@Param("roleId") String roleId, @Param("moduleType") Integer moduleType);
    ...
    int deletePermissionByRole(@Param("roleId") String roleId,@Param("moduleType") Integer moduleType);

    int insertRolePerm(@Param("roleId") String roleId, @Param("permId") Integer permId);
    ...
    void updateDataPerm(@Param("roleId") String roleId, @Param("permId") Integer permId, @Param("dataPerm") Integer dataPerm, @Param("dataPermDesc")String perm);

    List<DataPermCacheVO> findRolePermListByRoleId(@Param("roleId")String roleNum);
