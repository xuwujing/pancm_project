...
import com.zans.mms.vo.deny.DenyVO;
import com.zans.mms.vo.ip.IpVO;
...
public class AssetRespVO {
    ...
    @ApiModelProperty(name = "area", value = "所属辖区ID")
    @JSONField(name = "area")
    ...
    @JSONField(name = "cur_mac_addr")
    @ApiModelProperty(name = "cur_mac_addr",value = "当前Mac地址")
    ...
    @JSONField(name = "check_last_time", format = "yyyy-MM-dd HH:mm:ss")
    ...
    @JSONField(name = "deal_last_time" , format = "yyyy-MM-dd HH:mm:ss")
