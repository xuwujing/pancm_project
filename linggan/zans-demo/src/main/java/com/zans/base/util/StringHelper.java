...
//    }
    ...
    public static boolean isSpaceMacValid(String mac) {
        return (mac != null && mac.matches(MacAddressValidator.MAC_SPACE_PATTERN));
    }

    public static boolean isShortMacValid(String mac) {
        return (mac != null && mac.matches(MacAddressValidator.MAC_SHORT_PATTERN));
    }

    public static boolean isLineMacValid(String mac) {
        return (mac != null && mac.matches(MacAddressValidator.MAC_LINE_PATTERN));
    }
    ...
    **/
    ...
    public static String getPortId(String nasPortId) {
