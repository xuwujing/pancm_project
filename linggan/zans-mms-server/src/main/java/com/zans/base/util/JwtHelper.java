...
import com.zans.MmsApplication;
...
public class JwtHelper {
     ...
     * token私钥
     */
    private static final String TOKEN_SECRET = "kxky#jdk-8u2419524587417$12"+MmsApplication.PROJECT_START_TIME;
    ...
    public String signUser(SysUser sysUser){
        ...
        return JWT.create().withHeader(header)
                ...
                .withClaim(SESSION_KEY_JURISDICTION_ID,sysUser.getJurisdictionId())
                .withExpiresAt(date).sign(algorithm);
    }
    ...
    public UserSession getUserSession(String token) {
        ...
        try {
            ...
            session.setJurisdictionId(getClaimAsString(jwt,SESSION_KEY_JURISDICTION_ID));
            return session;
        } catch (Exception e) {
