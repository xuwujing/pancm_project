...
public class ImageHelper {
     ...
     * @return
     */
    public static byte[] compressOrigincalImage(byte[] imageByte, boolean auto ) {
        ...
        try {
            ...
            if(width>=height){
                height=720;
                Double scale_w = getDot2Decimal(width, height);
                width=parseDoubleToInt(720*scale_w);
            }else{
                width=720;
                Double scale_h = getDot2Decimal(height, width);
                height=parseDoubleToInt(720*scale_h);
            }
             return compressImage(imageByte,width,height,auto);
        }catch (Exception e){
    ...
    /**
     * 2021/8/2修改 原width:60 height:60
     * @param imageByte
     * @param auto
     * @return
     */
    public static byte[] compressImage(byte[] imageByte,boolean auto){
        return compressImage(imageByte,120,120,auto);
    }
