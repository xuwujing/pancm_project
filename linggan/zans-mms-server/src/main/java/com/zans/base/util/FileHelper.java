...
//            int separatorIndex = path.lastIndexOf(File.separator);
    ...
    public static String getFilePath( String fileUrl,String fileName) {
        if (fileUrl == null || fileName ==null) {
            return null;
        } else {

            return substringBefore(fileUrl,fileName);
        }
    }
...
//        System.out.println(FileHelper.readResourcesFile(VERSION_NAME));
        String src = "D:\\home\\release\\diagnosis\\2021\\6\\1\\9\\34020000001320000002\\2223.jpg";
        String des = "D:\\home\\11.jpg";
        FileHelper.fileCopy(src,des);
    }
