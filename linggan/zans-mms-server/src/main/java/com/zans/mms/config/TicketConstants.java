...
public class TicketConstants {
    ...
    public static String DEAL_WAY = "deal_way";
    ...
    public static final String DISPATCH_OP_TYPE_NAME = "派工单";
    public static final String ACCEPT_OP_TYPE_NAME = "验收单";
    ...
    public static final String TICKET_AGREE_NO_NAME = "驳回";
    public static final String TICKET_AGREE_YES_NAME = "同意";
    public static final String TICKET_AGREE_RETURN_NAME = "退回修改";
    ...
    public static final String BUILD_ROLE="0201";
     ...
     * 1.全部；2.待审批；3.已审批
     */
    public static final Integer TICKET_PENDING_APPROVAL = 2;
    /**
     * 1.全部；2.待审批；3.已审批
     */
    public static final Integer TICKET_APPROVAL = 3;
    /**
     * 1.全部；2.待审批；3.已审批
     */
    public static final Integer TICKET_All_APPROVAL = 1;
