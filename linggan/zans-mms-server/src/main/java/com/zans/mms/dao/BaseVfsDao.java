...
public interface BaseVfsDao extends Mapper<BaseVfs> {
	...
	List<BaseVfs> getDispatchAdjunctList(Long id);

	void updateSort(BaseVfs baseVfs);

	List<BaseVfs> getPoImg(String beforeAdjunctId);

	List<BaseVfs> getByAdjunctId(@Param("adjunctId") String beforeAdjunctId);
}
