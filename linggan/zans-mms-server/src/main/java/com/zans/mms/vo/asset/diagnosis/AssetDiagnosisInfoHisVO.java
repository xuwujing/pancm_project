...
/**
 * @author beixing
 * @Title: (AssetDiagnosisInfoHis)请求响应对象
 * @Description:
 * @Version:1.0.0
 * @Since:jdk1.8
 * @date 2021-05-14 18:24:44
 */
@ApiModel(value = "AssetDiagnosisInfoHis", description = "")
@Data
public class AssetDiagnosisInfoHisVO extends BasePage implements Serializable {
    private static final long serialVersionUID = 506654872408356792L;
    /**
     * 自增id
     */
