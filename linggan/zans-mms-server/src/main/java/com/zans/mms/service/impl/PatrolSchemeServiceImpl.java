...
import com.zans.mms.dao.PatrolSchemeMapper;
import com.zans.mms.dao.PatrolTaskCheckResultMapper;
import com.zans.mms.dao.PatrolTaskMapper;
...
public class PatrolSchemeServiceImpl extends BaseServiceImpl<PatrolScheme> implements IPatrolSchemeService {
	...
	public int updateSchemeAndJob(PatrolScheme reqVO) {
    	...
    	//修改定时任务表的启用停用状态
		cronJobService.updateStatus("patrol",reqVO.getId(),reqVO.getEnableStatus());
		return count;
	}
