...
public class MMSConstants {
    ...
    public static final int TICKET_TEMPLATE_RECORD = 14;
    ...
    **/
    ...
    public static final String LOG_OPERATION_UPLOAD = "上传";
    public static final String LOG_OPERATION_DIAGNOSIS = "标记数据";
    public static final String LOG_OPERATION_LOGIN = "登陆";
    public static final String LOG_OPERATION_CREATE = "创建";
    public static final String LOG_OPERATION_ADD_POINT = "添加点位";
    public static final String LOG_OPERATION_DEL_POINT = "删除点位";
    public static final String LOG_OPERATION_ADD_LOGS = "添加评论";
    ...
    **/
    ...
    public static final String MODULE_APP_BASE_FILE = "app附件管理";
    public static final String MODULE_PUBLIC_OPINION = "舆情投诉管理";
