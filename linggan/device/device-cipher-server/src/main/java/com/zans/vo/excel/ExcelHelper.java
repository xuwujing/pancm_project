...
import com.zans.vo.HeaderComparator;
import com.zans.vo.SheetEntity;
import com.zans.vo.ValidateHelper;
import com.zans.vo.ValidateResult;
...
import static com.zans.constant.BaseConstants.EXCEL_MAX_EMPTY_HEADER_COUNT;
import static com.zans.constant.BaseConstants.EXCEL_ROW_TYPE_NORMAL;
...
public class ExcelHelper {
    ...
    public static SheetEntity readExcelSheet(Sheet sheet, ExcelSheetReader reader) {
        try {
            ...
            //从注解中获取校验相关
            List<com.zans.vo.Header> headers = getSheetHeader(sheet, reader);
...
//                    log.info("{}#{}", count, obj);
     ...
     * @return
     */
    public static List<com.zans.vo.Header> getHeadersFromClass(Class clazz, boolean ignore, boolean seqColumn) {
        List<com.zans.vo.Header> headers = new LinkedList<>();
        if (seqColumn) {
            com.zans.vo.Header seqHeader = com.zans.vo.Header.builder()
...
//            log.info("ep#{}, {}, {}", ep.value(), ep.ignore(), ignore);
            ...
            com.zans.vo.Header header = com.zans.vo.Header.builder()
                    .fileName(ep.value())
                    .width(ep.width())
                    .col(ep.index())
                    .fieldName(fieldName)
    ...
    public static List<com.zans.vo.Header> getSheetHeader(Sheet sheet, ExcelSheetReader reader) {
        // 获得 Annotation 中的定义 加入到head中
        List<com.zans.vo.Header> headers = getHeadersFromClass(reader.getHeaderClass(), false, false);
        ...
        for(Integer index : rowNumbers) {
            ...
            for (com.zans.vo.Header header : headers) {
...
//        log.info("fix rowNumbers#{}", fixRowNumbers);
    ...
    private static ExcelRow parseRow(Sheet sheet, int rowIndex, List<com.zans.vo.Header> headers, List<String> notNullFields) throws Exception{
        // POI 中，边框不算空行
