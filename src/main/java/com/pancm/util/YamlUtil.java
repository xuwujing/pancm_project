...
public class YamlUtil {
    ...
    public enum ConfigValueTypeEnum {
        ...
        static {
            indexEnumMap = Arrays.stream(ConfigValueTypeEnum.values()).collect(Collectors.toMap(
                ConfigValueTypeEnum::ordinal, e -> e));
            nameEnumMap = Arrays.stream(ConfigValueTypeEnum.values()).collect(Collectors.toMap(
                ConfigValueTypeEnum::name, e -> e));
        }
