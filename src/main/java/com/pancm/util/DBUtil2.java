...
public class DBUtil2 {
	...
	private static Logger logger = LoggerFactory.getLogger(DBUtil2.class);




	private static Connection getConnection() throws SQLException {
		return new ConnectionManager2(2).getConnection(2);
	}

	private static Connection getConnection(int i) throws SQLException {
		return new ConnectionManager2(i).getConnection(i);
	}
