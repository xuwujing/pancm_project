...
//        httpRequestFactory.setReadTimeout(readTimeoutSeconds * 1000);
    ...
    public JSONObject getForObject(String url, int timeout) {
    ...
    public JSONObject postHttpsForObject(String url, Map<String, Object> postMap) {
    ...
    public JSONObject postForObject(String url, Map<String, Object> postMap) {
        RestTemplate restTemplate = getDefaultRestTemplate();
        JSONObject result = null;
        try {
            MultiValueMap<String, String> map= new LinkedMultiValueMap<String, String>();
    ...
    public static JSONObject sendPostRequest(String url, MultiValueMap<String, String> params, HttpMethod method) {
