 ...
 * @Author pancm
 * @Description
 * 代码来源: https://blog.csdn.net/DaveBobo/article/details/51308601
 * @Date  2020/12/21
 * @Param
 * @return
 **/
...
public class SnmpHelper {
    ...
    public static String convertMacToOid(String mac) {
        ...
        return joinCollection(oidList, SEPARATOR_DOT);
    }

    public static boolean isSpaceMacValid(String mac) {
        return (mac != null && mac.matches(MAC_SPACE_PATTERN) );
    }
