...
public class HBasePageModel implements Serializable {
    ...
    /**
     * Instantiates a new H base page model.
     *
     ...
     * 设置每页起始行键
     *
     * @param pageStartRowKey the page start row key
     */
     ...
     * 设置每页结束行键
     *
     * @param pageEndRowKey the page end row key
     */
...
//这个判断是不严谨的，因为很有可能剩余的数据刚好够一页。
     ...
     * 获取已检索总记录数
     *
     * @param queryTotalCount the query total count
     */
     ...
     * 获取秒格式的耗时信息
     *
     * @return time interval by second
     */
